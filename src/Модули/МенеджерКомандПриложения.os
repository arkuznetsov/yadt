...
Процедура ЗарегистрироватьКоманды(Знач Парсер) Экспорт
	...
	ДобавитьКоманду("incver"		, "КомандаИзменитьВерсиюПодсистемы"		, Парсер);
	ДобавитьКоманду("makecf"		, "КомандаСоздатьФайлОбновления"		, Парсер);
	ДобавитьКоманду("updstorage"	, "КомандаОбновитьХранилищеИзФайла"		, Парсер);
	ДобавитьКоманду("updib"			, "КомандаОбновитьИБИзХранилища"		, Парсер);
